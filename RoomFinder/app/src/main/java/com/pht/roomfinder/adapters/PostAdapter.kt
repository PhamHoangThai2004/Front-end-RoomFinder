...
import com.pht.roomfinder.databinding.ItemRecyclerPostBinding
...
class PostAdapter(private var list: List<Post>, private val onClick: (Int) -> Unit) :
    RecyclerView.Adapter<PostAdapter.ViewHolder>() {

    inner class ViewHolder(val bin: ItemRecyclerPostBinding) : RecyclerView.ViewHolder(bin.root) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val bin =
            ItemRecyclerPostBinding.inflate(LayoutInflater.from(parent.context), parent, false)
